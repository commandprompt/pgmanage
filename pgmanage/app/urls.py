...
base_urlpatterns = [
    ...
    re_path(r'^clear_commands_history/', views.commands_history.clear_commands_history,),
    re_path(r'^get_commands_history/', views.commands_history.get_commands_history),
