...
class ConnectionModelTests(TestCase):
    ...
    def test_get_credentials_extra_decrypts_secrets(self, mock_decrypt):
        ...
        resolved = connection.resolve_credentials_extra(
            {
                ...
                "access_key_id": "",
                "secret_access_key": "typed-secret",
            },
            "key",
        )
    ...
    def test_masked_credentials_extra_hides_secrets(self):
        connection = Connection(
            user_id=1,
            credentials_extra={
                "auth_method": "iam",
    ...
    def test_set_credentials_extra_encrypts_secrets(self, mock_encrypt):
